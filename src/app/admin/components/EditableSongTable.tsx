...
declare module "@tanstack/react-table" {
	interface TableMeta<TData extends RowData> {
		...
		editedRows: IMap<string, unknown[]>;
		setEditedRows: Dispatch<SetStateAction<IMap<string, unknown[]>>>;
	}
...
export default function EditableSongTable({ songs }: PropType) {
	...
	const [editedRows, setEditedRows] = useState<IMap<string, unknown[]>>(IMap());
